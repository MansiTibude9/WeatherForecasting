# WeatherForecasting
The application is about the predicting the weather and as per the weather, it will give the suggestion to users.
The application will contain the prediction and suggestions for application user:

- Rain {none, light, heavy, lightning}
- Maintenance {yes, no}
